            ...
            <div class="service-content">
              <h2 class="s-title"> Total Customer</h2>
               <h1 class="s-description text-center">
					<?php  echo countRecord("select * from  signup",$db);?></h1>
            </div>
          </div>
        </div>
          ...
          <div class="service-box" id="profileborder">
            ...
            <div class="service-content">
              <h2 class="s-title"> Total Orders</h2>
                <h1 class="s-description text-center">
						<?php  echo countRecord("select * from  payment where payment_status='complete' AND status='disabled'",$db);?> / <?php  echo countRecord("select * from  payment where payment_status='complete'",$db);?>  </h1>
            </div>
          </div>
        </div>
          ...
          <div class="service-box" id="profileborder">
            ...
            <div class="service-content">
              <h2 class="s-title"> Total Sale</h2>
				...
				$sql="select  sum(total) as mytot from payment where payment_status='complete'";
				$res=$db->query($sql);
